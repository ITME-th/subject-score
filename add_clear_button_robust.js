...
`;
  ...
  // Use regex to match the button text and closing tag regardless of newlines
  c = c.replace(/<span>📤 ส่งออก ปพ\.5<\/span>\s*<\/button>/g, '<span>📤 ส่งออก ปพ.5</span></button>' + buttonCode);
}

fs.writeFileSync(file, c);
console.log('Added Clear All Students button robustly');
