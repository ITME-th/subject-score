  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8 pb-12 w-full">
      <div className="flex justify-between items-end">
        ...
        <Link 
          href="/courses/create" 
          className="flex items-center space-x-2 px-5 py-2.5 bg-emerald-600 hover:bg-emerald-700 active:scale-[0.98] text-white rounded-xl font-semibold shadow-lg shadow-emerald-500/20 transition-all duration-200"
        >
